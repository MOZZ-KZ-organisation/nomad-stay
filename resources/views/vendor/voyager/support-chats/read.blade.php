...
<div class="page-content container-fluid">
    ...
    <form action="{{ route('voyager.support-messages.store', $dataTypeContent->id) }}" method="POST" style="margin-top: 15px;">
        @csrf
